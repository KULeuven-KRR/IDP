...
%Practically speaking in XSB, as in Prolog, by default the goal $G$
%raises an exception, so if goals like $G$ should fail, a Prolog flag
%must be set to change the behavior.  $G$ should be undefined, a simi
