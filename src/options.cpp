...
Options::Options(bool verboseOptions): _isVerbosity(verboseOptions) {
	...
	if (verboseOptions) {
		...
		BoolPol::createOption(BoolType::CPGROUNDATOMS, "cpgroundatoms", boolvalues, false, _option2name, PrintBehaviour::DONOTPRINT);
		...
		BoolPol::createOption(BoolType::XSB, "xsb", boolvalues, false, _option2name, PrintBehaviour::DONOTPRINT);
