...
\end{lstlisting}
Note that it is possible to use numerals as constructor functions, in which case the constructed type should be a subtype of a numeric type. For instance:
\begin{lstlisting}
	type SmallPrimes isa nat constructed from {2;3;5;7}
\end{lstlisting}
