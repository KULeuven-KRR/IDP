...
\begin{description}
	...
	\item[explainUnsat(theory, structure, vocabulary)]
		Returns a subset-minimal subset of the given structure and theory, so that the structure does not satisfy the theory. This will also print the theory. Possibly over a vocabulary, in which case the structure will only be subset-minimal over this vocabulary.
