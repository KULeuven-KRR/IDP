...
\begin{description}
	...
	\item[explainunsat(theory, structure, vocabulary)]
		Returns and prints a subset-minimal subset of the given structure and theory, so that the structure does not satisfy the theory. Possibly over a vocabulary, in which case the structure will only be subset-minimal over this vocabulary.
