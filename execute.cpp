...
class PrintTheoryInference: public InternalProcedure {
	public:
		PrintTheoryInference(): InternalProcedure("tostring") {
			add(AT_THEORY);
			add(AT_OPTIONS);
		}

		InternalArgument execute(const vector<InternalArgument>& args, lua_State* ) {
